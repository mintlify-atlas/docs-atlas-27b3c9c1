...
<Steps>
  ...
  <Step title="Enable the private endpoint for internal traffic">
    Setting `cluster_endpoint_private_access = true` allows nodes to communicate with the API server over the private network. Ensure VPC DNS resolution and DNS hostnames are enabled.
  </Step>
